...
/**
 * Created by Devesh Anand on 02-07-2017.
 */
...
public class RecyclerViewReboundAnimatorHorizontal{
    ...
    public RecyclerViewReboundAnimatorHorizontal(RecyclerView recyclerView) {
            ...
            public void run() {
                ...
                spring.addListener(new SimpleSpringListener() {
                    ...
                    public void onSpringUpdate(Spring spring) {
                        ...
                        float val = (float) (mWidth - spring.getCurrentValue());
