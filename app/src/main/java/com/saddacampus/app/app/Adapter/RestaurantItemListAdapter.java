...
public class RestaurantItemListAdapter extends RecyclerView.Adapter<RestaurantItemListAdapter.RestaurantItemViewHolder> {
    ...
    public RestaurantItemListAdapter(ArrayList<RestaurantItem> restaurantArrayList, Context context) {
